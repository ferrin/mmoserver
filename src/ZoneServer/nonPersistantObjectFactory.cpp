...
//(this,11,1320,entertainer->getId(),99,Anh_Math::Vector3(),"");
{
	...
	int8 sql[256];
	snprintf(sql,sizeof(sql),"SELECT item_types.object_string,item_types.stf_name,item_types.stf_file,item_types.stf_detail_name, item_types.stf_detail_file FROM item_types WHERE item_types.id = '%u'",typeId);
